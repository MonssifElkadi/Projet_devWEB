...
@section('content')
    ...
    <div style="margin-top: 30px;">
        <h2 style="color: #2c3e50; border-bottom: 3px solid #3498db; padding-bottom: 10px;">📦 Catalogue des Ressources</h2>
                        ...
                        @foreach($resources as $resource)
                            <tr style="background: #fff; border: 1px solid #ddd;">
                                ...
                                <td style="padding: 12px; border: 1px solid #ddd; text-align: center;">
                                    ...
                                    @else
                                        <span
                                            style="background: #e74c3c; color: white; padding: 5px 10px; border-radius: 3px; font-weight: bold;">🔧
                                            Maintenance</span>
                                    @endif
                                </td>
                            </tr>
