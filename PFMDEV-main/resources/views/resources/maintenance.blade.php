    ...
    <div class="container-wrapper">
        ...
        <main>
            <header>
                ...
                <p>Resources currently under maintenance or diagnostic procedures.</p>
            </header>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchResources() {
                ...
                fetch('/maintenances/ajax-filter?' + params.toString())
                    .then(res => res.text())
                    .then(html => {
                ...
                @if(auth()->user()->canManage())
                    ...
                    if (createForm) {
                        createForm.addEventListener('submit', function (e) {
                            e.preventDefault();
                            console.log('Create form submitted (maintenance)');
                            ...
                            console.log('Submitting form data (maintenance)...');
